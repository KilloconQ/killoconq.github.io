import { e as createComponent, m as maybeRenderHead, h as addAttribute, r as renderTemplate, f as createAstro, i as renderHead, j as renderComponent, k as renderSlot } from '../chunks/astro/server_BSHS1Ia5.mjs';
import 'kleur/colors';
import 'html-escaper';
/* empty css                                 */
import 'clsx';
...
const rdsImage = new Proxy({"src":"/_astro/rds.DdpHnR9s.png","width":1752,"height":1230,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/fernandocorrales/Dev/projects/web/portfolio/src/assets/images/rds.png";
							}
